...
def main(target,timeout,proxy,cookies):
    try:
        ...
        print('Found: {} Subdomain'.format(hijau(len(sub.subdomain()))))
        for subd in sub.subdomain():
            print('- {}'.format(hijau(subd)))            
        print(batas)
        log.log(10,'Retreive Host Information')
        log.log(50,' + DNS Server')
        print(sub.dns())
        print(batas)
        log.log(50,' + MX Records')
        print(sub.mx())
        print(batas)
        log.log(50,' + TXT Records')
        print(sub.txt())        
        log.log(50,'Subdomain Information')
        print(sub.subInfo())
        print(batas)
